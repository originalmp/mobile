<!-- START of /inc/locations/stores/laval.php  -->
 <ul class="store-location">
  <li class="store-image"><img src="./images/locations/laval.jpg" title="Canada Computers and Electronics" alt="Canada Computers and Electronics"></li>
  ...
  <a href="tel:450-934-6969"><li class="store-phone"><img class="phone-icon" src="./images/phone.png"> 450-934-6969<span class="chevron"><img class="chevron-icon" src="./images/chevron.png"></span></li></a>
  <a class="email" href="mailto:laval@ordinateurscanada.com">
  <li>E: laval@ordinateurscanada.com</li>
  </a>
  <li class="inquiries">For inquiries regarding Service or System build contact our Service Centre:</li>
  <!-- a class="email" href="mailto:lavalservice@ordinateurscanada.com">
  <li>E: lavalservice@ordinateurscanada.com</li>
  </a -->
  <li class="inquiries">Government/Corporate &amp; Reseller Sales/Business Solutions:</li>
  <a class="email" href="mailto:corporatif@ordinateurscanada.com">
