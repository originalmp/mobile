<!-- START of /inc/locations/stores/milton.php  -->


 <ul class="store-location">
        <li class="store-image"><img src="./images/locations/milton.jpg" alt="Canada Computers and Electronics"></li>
...
<a href="tel:289-851-7945"><li class="store-phone"><img class="phone-icon" src="./images/phone.png">289-851-7945<span class="chevron"><img class="chevron-icon" src="./images/chevron.png"></span></li></a>
  <!-- a class="email" href="mailto:milton@canadacomputers.com">
  <li>E: milton@canadacomputers.com</li>
  </a -->
  <li class="inquiries">For inquiries regarding Service or System build contact our Service Centre:</li>
  <a class="email"  href="mailto:miltonservice@canadacomputers.com">
